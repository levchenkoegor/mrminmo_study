...
export tr_counts=1515 # all runs (505, 505, 505)
  ...
  (
    for cond in "MinMo" "NoMinMo"; do
      ...
      3dDeconvolve -input ${subj_preproc_outputs}/pb03.$subj.r*.scale+orig.HEAD \
          ...
          -stim_times 1 ${stim_folder}/subjectwise/condition-cough_sub-${subj}_cond-${cond}_runs-*.1D 'TENT(0, 4, 6)' \
          -stim_times 2 ${stim_folder}/subjectwise/condition-crosslegsleftontop_sub-${subj}_cond-${cond}_runs-*.1D 'TENT(0, 4, 6)' \
          -stim_times 3 ${stim_folder}/subjectwise/condition-crosslegsrightontop_sub-${subj}_cond-${cond}_runs-*.1D 'TENT(0, 4, 6)' \
          -stim_times 4 ${stim_folder}/subjectwise/condition-lefthandtorightthigh_sub-${subj}_cond-${cond}_runs-*.1D 'TENT(0, 4, 6)' \
          -stim_times 5 ${stim_folder}/subjectwise/condition-righthandtoleftthigh_sub-${subj}_cond-${cond}_runs-*.1D 'TENT(0, 4, 6)' \
          -stim_times 6 ${stim_folder}/subjectwise/condition-raiselefthip_sub-${subj}_cond-${cond}_runs-*.1D 'TENT(0, 4, 6)' \
          -stim_times 7 ${stim_folder}/subjectwise/condition-raiserighthip_sub-${subj}_cond-${cond}_runs-*.1D 'TENT(0, 4, 6)' \
          -stim_times 8 ${stim_folder}/subjectwise/condition-sayHellotheremum_sub-${subj}_cond-${cond}_runs-*.1D 'TENT(0, 4, 6)' \
          -stim_times 9 ${stim_folder}/subjectwise/condition-scratchleftcheek_sub-${subj}_cond-${cond}_runs-*.1D 'TENT(0, 4, 6)' \
          -stim_times 10 ${stim_folder}/subjectwise/condition-scratchrightcheek_sub-${subj}_cond-${cond}_runs-*.1D 'TENT(0, 4, 6)' \
          -iresp 1 ${subj_preproc_outputs}/iresp_cough_tent_00-40.nii.gz \
          -iresp 2 ${subj_preproc_outputs}/iresp_crosslegsleftontop_tent_00-40.nii.gz \
          -iresp 3 ${subj_preproc_outputs}/iresp_crosslegsrightontop_tent_00-40.nii.gz \
          -iresp 4 ${subj_preproc_outputs}/iresp_lefthandtorightthigh_tent_00-40.nii.gz \
          -iresp 5 ${subj_preproc_outputs}/iresp_righthandtoleftthigh_tent_00-40.nii.gz \
          -iresp 6 ${subj_preproc_outputs}/iresp_raiselefthip_tent_00-40.nii.gz \
          -iresp 7 ${subj_preproc_outputs}/iresp_raiserighthip_tent_00-40.nii.gz \
          -iresp 8 ${subj_preproc_outputs}/iresp_sayHellotheremum_tent_00-40.nii.gz \
          -iresp 9 ${subj_preproc_outputs}/iresp_scratchleftcheek_tent_00-40.nii.gz \
          -iresp 10 ${subj_preproc_outputs}/iresp_scratchrightcheek_tent_00-40.nii.gz \
          ...
          -fout -tout -x1D ${subj_preproc_outputs}/X_tent_00-40.xmat.1D -xjpeg ${subj_preproc_outputs}/X_tent_00-40.jpg \
          -fitts ${subj_preproc_outputs}/fitts_tent_00-40.${subj} \
          -errts ${subj_preproc_outputs}/errts_tent_00-40.${subj} \
          -bucket ${subj_preproc_outputs}/stats_tent_00-40.${subj}

      mv ${subj_preproc_outputs}/../sub-${subj}_task-mvts_cond-${cond}.REML_cmd ${subj_preproc_outputs}/sub-${subj}_task-mvts_cond-${cond}_tent_00-40.REML_cmd
      bash ${subj_preproc_outputs}/sub-${subj}_task-mvts_cond-${cond}_tent_00-40.REML_cmd
